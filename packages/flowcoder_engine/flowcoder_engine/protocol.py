...
class ProtocolHandler:
    ...
    def emit_block_start(
        self, block_id: str, block_name: str, block_type: str, *, has_output_schema: bool = False
    ) -> None:
    ...
    def emit_block_complete(
        self, block_id: str, block_name: str, success: bool, *, has_output_schema: bool = False
    ) -> None:
